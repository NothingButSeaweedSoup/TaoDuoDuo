<%@ page contentType="text/html;charset=UTF-8" language="java" %>
    <% String username=(String) session.getAttribute("username"); boolean isLoggedIn=(username !=null &&
        !username.isEmpty()); %>
            ...
            <div class="navbar-container">
                ...
                <div class="navbar-left">
                    <a href="${pageContext.request.contextPath}/index.jsp" class="navbar-logo">
                        <img src="${pageContext.request.contextPath}/icon/logo-white.png" alt="淘多多"
