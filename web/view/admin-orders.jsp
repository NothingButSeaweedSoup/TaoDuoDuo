            ...
            <%@ include file="head.jsp" %>
                ...
                <div class="container">
                    ...
                    <div class="breadcrumb">
                        <a href="${pageContext.request.contextPath}/AdminDashboardServlet">管理员控制台</a> > 订单管理
                    </div>

                    <!-- 页面头部 -->
                    <div class="page-header">
                        <div class="page-title">订单管理</div>
                        <div class="page-subtitle">管理平台上的所有订单信息</div>
                    </div>
                    ...
                    <div class="orders-container">
                        <div class="orders-header">
                            <div class="orders-title">订单列表 (${orders.size()} 个订单)</div>
                        </div>
