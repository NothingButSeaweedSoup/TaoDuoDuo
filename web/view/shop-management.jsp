    ...
    <div class="container">
        ...
        <div class="content-card">
            ...
            <% 
                ...
                List<Shop> userShops = (List<Shop>) request.getAttribute("userShops");
            %>
            ...
            <% } else { %>
                ...
                <div class="empty-state">
                    ...
                    <a href="${pageContext.request.contextPath}/ProfileServlet" class="btn btn-primary">
                        前往申请入驻
                    </a>
                </div>
            <% } %>
