                ...
                <%@ include file="head.jsp" %>
                    ...
                    <div class="container">
                        ...
                        <c:if test="${not empty sessionScope.paymentSuccessMessage}">
                            <div
                                style="background: #d4edda; border: 1px solid #c3e6cb; color: #155724; padding: 15px; border-radius: 4px; margin-bottom: 20px;">
                                        ...
                                        <span class="info-value">
                                            <span class="order-status status-${order.order_status}">
                                                <c:choose>
                                                    ...
                                                    <c:when test="${order.order_status == 'shipped_pending_receipt'}">
                                                        待收货</c:when>
