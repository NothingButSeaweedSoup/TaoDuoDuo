...
public class ReviewService {
     ...
     * @return 评价列表
     */
    public Optional<List<Review>> getReviewsByProductId(int productId) {
        try {
     ...
     * @return 评价统计信息
     */
    public Optional<ReviewDao.ReviewStatistics> getReviewStatisticsByProductId(int productId) {
        try {
            return reviewDao.getReviewStatisticsByProductId(productId);
        } catch (Exception e) {
            e.printStackTrace();
            return Optional.empty();
        }
